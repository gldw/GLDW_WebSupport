...
( function( $ ) {
	 ...
	 * .page
	 */
	wp.customize( 'awesomepress[container-width-page]', function( value ) {
		value.bind( function( newval ) {
			var selector  = '.error404 .site-content > .inner,';
				selector += '.page .site-content > .inner,';
	 ...
	 * .search
	 */
	wp.customize( 'awesomepress[container-width-archive]', function( value ) {
		value.bind( function( newval ) {
			var selector  = '.archive .site-content > .inner,';
				selector += '.search .site-content > .inner,';
				selector += '.blog .site-content > .inner,';
	 ...
	 * .single
	 */
	wp.customize( 'awesomepress[container-width-single]', function( value ) {
		value.bind( function( newval ) {
			var selector  = '.single .site-content > .inner,';
